...
(function(root, factory) {
  ...
  describe('ServiceApi', function() {
    ...
    describe('serviceMetadataIdGet', function() {
      it('should call serviceMetadataIdGet successfully', function(done) {
        //uncomment below and update the code to test serviceMetadataIdGet
        //instance.serviceMetadataIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
