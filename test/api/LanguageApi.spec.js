...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.LanguageApi();
  });
  ...
  describe("LanguageApi", function() {
    describe("languagesDefaultGet", function() {
      it("should call languagesDefaultGet successfully", function() {
        instance.apiClient.callApi = sinon.stub().returns("result");
        var callback = "callback";
        var result = instance.languagesDefaultGet(callback);
    ...
    describe("languagesGet", function() {
      it("should call languagesGet successfully", function() {
        instance.apiClient.callApi = sinon.stub().returns("result");
        var callback = "callback";
        var result = instance.languagesGet(callback);
        expect(result).to.be.equal("result");
        expect(instance.apiClient.callApi.calledOnce).to.be(true);
        expect(instance.apiClient.callApi.args[0][0]).to.be.equal("/languages");
        expect(instance.apiClient.callApi.args[0][1]).to.be.equal("GET");
        expect(instance.apiClient.callApi.args[0][2]).to.eql({});
        expect(instance.apiClient.callApi.args[0][3]).to.eql({});
        expect(instance.apiClient.callApi.args[0][4]).to.eql({});
