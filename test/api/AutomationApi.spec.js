...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.AutomationApi();
  });
  ...
  describe("AutomationApi", function() {
    describe("automationCreatePost", function() {
      it("should throw error if body is missed", function() {
        expect(instance.automationCreatePost).to.throwException(function(e) {
          expect(e.message).to.be.equal(
            "Missing the required parameter 'body' when calling automationCreatePost"
          );
        });
      });

      it("should call automationCreatePost successfully", function() {
        instance.apiClient.callApi = sinon.stub().returns("result");
        var body = "body";
        var callback = "callback";
        var result = instance.automationCreatePost(body, callback);
    ...
    describe("automationDeletePost", function() {
      it("should throw error if body is missed", function() {
        expect(instance.automationDeletePost).to.throwException(function(e) {
          expect(e.message).to.be.equal(
            "Missing the required parameter 'body' when calling automationDeletePost"
          );
        });
      });

      it("should call automationDeletePost successfully", function() {
        instance.apiClient.callApi = sinon.stub().returns("result");
        var body = "body";
        var callback = "callback";
        var result = instance.automationDeletePost(body, callback);
        expect(result).to.be.equal("result");
        expect(instance.apiClient.callApi.calledOnce).to.be(true);
        expect(instance.apiClient.callApi.args[0][0]).to.be.equal(
          "/automation/delete"
    ...
    describe("automationEditPost", function() {
      it("should throw error if body is missed", function() {
        expect(instance.automationEditPost).to.throwException(function(e) {
          expect(e.message).to.be.equal(
            "Missing the required parameter 'body' when calling automationEditPost"
          );
        });
      });

      it("should call automationEditPost successfully", function() {
        instance.apiClient.callApi = sinon.stub().returns("result");
        var body = "body";
        var callback = "callback";
        var result = instance.automationEditPost(body, callback);
        expect(result).to.be.equal("result");
        expect(instance.apiClient.callApi.calledOnce).to.be(true);
        expect(instance.apiClient.callApi.args[0][0]).to.be.equal(
          "/automation/edit/"
    ...
    describe("automationGet", function() {
      it("should call automationGet successfully", function() {
        instance.apiClient.callApi = sinon.stub().returns("result");
        var callback = "callback";
        var result = instance.automationGet(callback);
        expect(result).to.be.equal("result");
        expect(instance.apiClient.callApi.calledOnce).to.be(true);
        expect(instance.apiClient.callApi.args[0][0]).to.be.equal(
          "/automation"
    ...
    describe("automationMetadataIdGet", function() {
      it("should throw error if id is missed", function() {
        expect(instance.automationMetadataIdGet).to.throwException(function(e) {
          expect(e.message).to.be.equal(
            "Missing the required parameter 'id' when calling automationMetadataIdGet"
          );
        });
      });

      it("should call automationMetadataIdGet successfully", function() {
        instance.apiClient.callApi = sinon.stub().returns("result");
        var id = "id";
        var callback = "callback";
        var result = instance.automationMetadataIdGet(id, callback);
        expect(result).to.be.equal("result");
        expect(instance.apiClient.callApi.calledOnce).to.be(true);
        expect(instance.apiClient.callApi.args[0][0]).to.be.equal(
