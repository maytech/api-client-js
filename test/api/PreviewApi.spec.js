...
(function(root, factory) {
  ...
  describe('PreviewApi', function() {
    ...
    describe('previewIdGet', function() {
      it('should call previewIdGet successfully', function(done) {
        //uncomment below and update the code to test previewIdGet
        //instance.previewIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
