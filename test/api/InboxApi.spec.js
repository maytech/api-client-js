...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.InboxApi();
  });
  ...
  describe("InboxApi", function() {
    describe("inboxGet", function() {
      it("should call inboxGet successfully", function() {
