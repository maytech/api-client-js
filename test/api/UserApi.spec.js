...
(function(root, factory) {
  ...
  describe('UserApi', function() {
    ...
    describe('userDeletePost', function() {
      it('should call userDeletePost successfully', function(done) {
        //uncomment below and update the code to test userDeletePost
        //instance.userDeletePost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('userEditPost', function() {
      it('should call userEditPost successfully', function(done) {
        //uncomment below and update the code to test userEditPost
        //instance.userEditPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('userMetadataIdGet', function() {
      it('should call userMetadataIdGet successfully', function(done) {
        //uncomment below and update the code to test userMetadataIdGet
        //instance.userMetadataIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('userSignupPost', function() {
      it('should call userSignupPost successfully', function(done) {
        //uncomment below and update the code to test userSignupPost
        //instance.userSignupPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
