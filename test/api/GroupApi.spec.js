...
(function(root, factory) {
  ...
  describe("GroupApi", function() {
    ...
    describe("groupGet", function() {
      it("should call groupGet successfully", function() {
        instance.apiClient.callApi = sinon.stub().returns("result");
        var callback = "callback";
        var result = instance.groupGet(callback);
        expect(result).to.be.equal("result");
        expect(instance.apiClient.callApi.calledOnce).to.be(true);
        expect(instance.apiClient.callApi.args[0][0]).to.be.equal("/group");
        expect(instance.apiClient.callApi.args[0][1]).to.be.equal("GET");
        expect(instance.apiClient.callApi.args[0][2]).to.eql({});
        expect(instance.apiClient.callApi.args[0][3]).to.eql({});
        expect(instance.apiClient.callApi.args[0][4]).to.eql({});
    ...
    describe("groupMetadataIdGet", function() {
      it("should throw error if id is missed", function() {
        expect(instance.groupMetadataIdGet).to.throwException(function(e) {
          expect(e.message).to.be.equal(
            "Missing the required parameter 'id' when calling groupMetadataIdGet"
          );
        });
      });

      it("should call groupMetadataIdGet successfully", function() {
        instance.apiClient.callApi = sinon.stub().returns("result");
        var id = "id";
        var callback = "callback";
        var result = instance.groupMetadataIdGet(id, callback);
        expect(result).to.be.equal("result");
        expect(instance.apiClient.callApi.calledOnce).to.be(true);
        expect(instance.apiClient.callApi.args[0][0]).to.be.equal(
          "/group/metadata/{id}"
