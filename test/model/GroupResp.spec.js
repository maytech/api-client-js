...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.GroupResp();
  });
  ...
  describe('GroupResp', function() {
    it('should create an instance of GroupResp', function() {
      // uncomment below and update the code to test GroupResp
      //var instane = new QuatrixApi.GroupResp();
      //expect(instance).to.be.a(QuatrixApi.GroupResp);
    });
