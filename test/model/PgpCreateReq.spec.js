...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.PgpCreateReq();
  });
  ...
  describe('PgpCreateReq', function() {
    it('should create an instance of PgpCreateReq', function() {
      // uncomment below and update the code to test PgpCreateReq
      //var instane = new QuatrixApi.PgpCreateReq();
      //expect(instance).to.be.a(QuatrixApi.PgpCreateReq);
    });
