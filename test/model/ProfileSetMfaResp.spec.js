...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ProfileSetMfaResp();
  });
  ...
  describe('ProfileSetMfaResp', function() {
    it('should create an instance of ProfileSetMfaResp', function() {
      // uncomment below and update the code to test ProfileSetMfaResp
      //var instane = new QuatrixApi.ProfileSetMfaResp();
      //expect(instance).to.be.a(QuatrixApi.ProfileSetMfaResp);
    });
