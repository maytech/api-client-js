...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.QuicklinkLoginPinReq();
  });
  ...
  describe('QuicklinkLoginPinReq', function() {
    it('should create an instance of QuicklinkLoginPinReq', function() {
      // uncomment below and update the code to test QuicklinkLoginPinReq
      //var instane = new QuatrixApi.QuicklinkLoginPinReq();
      //expect(instance).to.be.a(QuatrixApi.QuicklinkLoginPinReq);
    });
