...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.IdName();
  });
  ...
  describe('IdName', function() {
    it('should create an instance of IdName', function() {
      // uncomment below and update the code to test IdName
      //var instane = new QuatrixApi.IdName();
      //expect(instance).to.be.a(QuatrixApi.IdName);
    });
