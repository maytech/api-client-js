...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.UploadLinkReq();
  });
  ...
  describe('UploadLinkReq', function() {
    it('should create an instance of UploadLinkReq', function() {
      // uncomment below and update the code to test UploadLinkReq
      //var instane = new QuatrixApi.UploadLinkReq();
      //expect(instance).to.be.a(QuatrixApi.UploadLinkReq);
    });
