...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.SshKeyCreateReq();
  });
  ...
  describe('SshKeyCreateReq', function() {
    it('should create an instance of SshKeyCreateReq', function() {
      // uncomment below and update the code to test SshKeyCreateReq
      //var instane = new QuatrixApi.SshKeyCreateReq();
      //expect(instance).to.be.a(QuatrixApi.SshKeyCreateReq);
    });
