...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.GroupMetadata();
  });
  ...
  describe('GroupMetadata', function() {
    it('should create an instance of GroupMetadata', function() {
      // uncomment below and update the code to test GroupMetadata
      //var instane = new QuatrixApi.GroupMetadata();
      //expect(instance).to.be.a(QuatrixApi.GroupMetadata);
    });
    ...
    it('should have the property translationId (base name: "translation_id")', function() {
      // uncomment below and update the code to test the property translationId
      //var instane = new QuatrixApi.GroupMetadata();
      //expect(instance).to.be();
    });

    it('should have the property visualOrder (base name: "visual_order")', function() {
      // uncomment below and update the code to test the property visualOrder
      //var instane = new QuatrixApi.GroupMetadata();
      //expect(instance).to.be();
    });
