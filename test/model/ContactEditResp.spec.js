...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ContactEditResp();
  });
  ...
  describe('ContactEditResp', function() {
    it('should create an instance of ContactEditResp', function() {
      // uncomment below and update the code to test ContactEditResp
      //var instane = new QuatrixApi.ContactEditResp();
      //expect(instance).to.be.a(QuatrixApi.ContactEditResp);
    });
