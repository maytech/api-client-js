...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ShareCreateResp();
  });
  ...
  describe('ShareCreateResp', function() {
    it('should create an instance of ShareCreateResp', function() {
      // uncomment below and update the code to test ShareCreateResp
      //var instane = new QuatrixApi.ShareCreateResp();
      //expect(instance).to.be.a(QuatrixApi.ShareCreateResp);
    });
