...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.PfSetUsersReq();
  });
  ...
  describe('PfSetUsersReq', function() {
    it('should create an instance of PfSetUsersReq', function() {
      // uncomment below and update the code to test PfSetUsersReq
      //var instane = new QuatrixApi.PfSetUsersReq();
      //expect(instance).to.be.a(QuatrixApi.PfSetUsersReq);
    });
