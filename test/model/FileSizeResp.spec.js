...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.FileSizeResp();
  });
  ...
  describe('FileSizeResp', function() {
    it('should create an instance of FileSizeResp', function() {
      // uncomment below and update the code to test FileSizeResp
      //var instane = new QuatrixApi.FileSizeResp();
      //expect(instance).to.be.a(QuatrixApi.FileSizeResp);
    });
