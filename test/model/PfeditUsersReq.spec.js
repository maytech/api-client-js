...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.PfeditUsersReq();
  });
  ...
  describe('PfeditUsersReq', function() {
    it('should create an instance of PfeditUsersReq', function() {
      // uncomment below and update the code to test PfeditUsersReq
      //var instane = new QuatrixApi.PfeditUsersReq();
      //expect(instance).to.be.a(QuatrixApi.PfeditUsersReq);
    });

    it('should have the property usersPermissions (base name: "users_permissions")', function() {
      // uncomment below and update the code to test the property usersPermissions
      //var instane = new QuatrixApi.PfeditUsersReq();
