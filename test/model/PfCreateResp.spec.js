...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.PfCreateResp();
  });
  ...
  describe('PfCreateResp', function() {
    it('should create an instance of PfCreateResp', function() {
      // uncomment below and update the code to test PfCreateResp
      //var instane = new QuatrixApi.PfCreateResp();
      //expect(instance).to.be.a(QuatrixApi.PfCreateResp);
    });
