...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.SearchTag();
  });
  ...
  describe('SearchTag', function() {
    it('should create an instance of SearchTag', function() {
      // uncomment below and update the code to test SearchTag
      //var instane = new QuatrixApi.SearchTag();
      //expect(instance).to.be.a(QuatrixApi.SearchTag);
    });
