...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.FileModifyResp();
  });
  ...
  describe('FileModifyResp', function() {
    it('should create an instance of FileModifyResp', function() {
      // uncomment below and update the code to test FileModifyResp
      //var instane = new QuatrixApi.FileModifyResp();
      //expect(instance).to.be.a(QuatrixApi.FileModifyResp);
    });
