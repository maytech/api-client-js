...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.UserPermissionReq();
  });
  ...
  describe('UserPermissionReq', function() {
    it('should create an instance of UserPermissionReq', function() {
      // uncomment below and update the code to test UserPermissionReq
      //var instane = new QuatrixApi.UserPermissionReq();
      //expect(instance).to.be.a(QuatrixApi.UserPermissionReq);
    });
