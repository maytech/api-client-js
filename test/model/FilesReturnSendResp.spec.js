...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.FilesReturnSendResp();
  });
  ...
  describe('FilesReturnSendResp', function() {
    it('should create an instance of FilesReturnSendResp', function() {
      // uncomment below and update the code to test FilesReturnSendResp
      //var instane = new QuatrixApi.FilesReturnSendResp();
      //expect(instance).to.be.a(QuatrixApi.FilesReturnSendResp);
    });
