...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.PfMetadataResp();
  });
  ...
  describe('PfMetadataResp', function() {
    it('should create an instance of PfMetadataResp', function() {
      // uncomment below and update the code to test PfMetadataResp
      //var instane = new QuatrixApi.PfMetadataResp();
      //expect(instance).to.be.a(QuatrixApi.PfMetadataResp);
    });
