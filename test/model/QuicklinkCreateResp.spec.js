...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.QuicklinkCreateResp();
  });
  ...
  describe('QuicklinkCreateResp', function() {
    it('should create an instance of QuicklinkCreateResp', function() {
      // uncomment below and update the code to test QuicklinkCreateResp
      //var instane = new QuatrixApi.QuicklinkCreateResp();
      //expect(instance).to.be.a(QuatrixApi.QuicklinkCreateResp);
    });
