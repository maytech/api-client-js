...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ProfileSetResp();
  });
  ...
  describe('ProfileSetResp', function() {
    it('should create an instance of ProfileSetResp', function() {
      // uncomment below and update the code to test ProfileSetResp
      //var instane = new QuatrixApi.ProfileSetResp();
      //expect(instance).to.be.a(QuatrixApi.ProfileSetResp);
    });
