...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.IdsReq();
  });
  ...
  describe('IdsReq', function() {
    it('should create an instance of IdsReq', function() {
      // uncomment below and update the code to test IdsReq
      //var instane = new QuatrixApi.IdsReq();
      //expect(instance).to.be.a(QuatrixApi.IdsReq);
    });
