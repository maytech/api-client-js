...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.UserRemoveMfaReq();
  });
  ...
  describe('UserRemoveMfaReq', function() {
    it('should create an instance of UserRemoveMfaReq', function() {
      // uncomment below and update the code to test UserRemoveMfaReq
      //var instane = new QuatrixApi.UserRemoveMfaReq();
      //expect(instance).to.be.a(QuatrixApi.UserRemoveMfaReq);
    });
