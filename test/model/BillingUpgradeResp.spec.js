...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.BillingUpgradeResp();
  });
  ...
  describe('BillingUpgradeResp', function() {
    it('should create an instance of BillingUpgradeResp', function() {
      // uncomment below and update the code to test BillingUpgradeResp
      //var instane = new QuatrixApi.BillingUpgradeResp();
      //expect(instance).to.be.a(QuatrixApi.BillingUpgradeResp);
    });
    ...
    it('should have the property upgradeInvoiceId (base name: "upgrade_invoice_id")', function() {
      // uncomment below and update the code to test the property upgradeInvoiceId
      //var instane = new QuatrixApi.BillingUpgradeResp();
      //expect(instance).to.be();
    });
