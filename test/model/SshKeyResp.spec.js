...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.SshKeyResp();
  });
  ...
  describe('SshKeyResp', function() {
    it('should create an instance of SshKeyResp', function() {
      // uncomment below and update the code to test SshKeyResp
      //var instane = new QuatrixApi.SshKeyResp();
      //expect(instance).to.be.a(QuatrixApi.SshKeyResp);
    });
