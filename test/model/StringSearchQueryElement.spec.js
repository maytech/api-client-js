...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.StringSearchQueryElement();
  });
  ...
  describe('StringSearchQueryElement', function() {
    it('should create an instance of StringSearchQueryElement', function() {
      // uncomment below and update the code to test StringSearchQueryElement
      //var instane = new QuatrixApi.StringSearchQueryElement();
      //expect(instance).to.be.a(QuatrixApi.StringSearchQueryElement);
    });
