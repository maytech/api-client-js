...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.SshKeyDeleteReq();
  });
  ...
  describe('SshKeyDeleteReq', function() {
    it('should create an instance of SshKeyDeleteReq', function() {
      // uncomment below and update the code to test SshKeyDeleteReq
      //var instane = new QuatrixApi.SshKeyDeleteReq();
      //expect(instance).to.be.a(QuatrixApi.SshKeyDeleteReq);
    });
