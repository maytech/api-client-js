...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.AccountInfoResp();
  });
  ...
  describe('AccountInfoResp', function() {
    it('should create an instance of AccountInfoResp', function() {
      // uncomment below and update the code to test AccountInfoResp
      //var instane = new QuatrixApi.AccountInfoResp();
      //expect(instance).to.be.a(QuatrixApi.AccountInfoResp);
    });
    ...
    it('should have the property serverLocation (base name: "server_location")', function() {
      // uncomment below and update the code to test the property serverLocation
      //var instane = new QuatrixApi.AccountInfoResp();
      //expect(instance).to.be();
    });
