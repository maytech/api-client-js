...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.FilesReturnUploadLinkReq();
  });
  ...
  describe('FilesReturnUploadLinkReq', function() {
    it('should create an instance of FilesReturnUploadLinkReq', function() {
      // uncomment below and update the code to test FilesReturnUploadLinkReq
      //var instane = new QuatrixApi.FilesReturnUploadLinkReq();
      //expect(instance).to.be.a(QuatrixApi.FilesReturnUploadLinkReq);
    });
