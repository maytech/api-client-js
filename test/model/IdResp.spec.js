...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.IdResp();
  });
  ...
  describe('IdResp', function() {
    it('should create an instance of IdResp', function() {
      // uncomment below and update the code to test IdResp
      //var instane = new QuatrixApi.IdResp();
      //expect(instance).to.be.a(QuatrixApi.IdResp);
    });
