...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.PfUsersListReq();
  });
  ...
  describe('PfUsersListReq', function() {
    it('should create an instance of PfUsersListReq', function() {
      // uncomment below and update the code to test PfUsersListReq
      //var instane = new QuatrixApi.PfUsersListReq();
      //expect(instance).to.be.a(QuatrixApi.PfUsersListReq);
    });
