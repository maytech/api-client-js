...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.AccountBrandingPreview();
  });
  ...
  describe('AccountBrandingPreview', function() {
    it('should create an instance of AccountBrandingPreview', function() {
      expect(instance).to.be.a(QuatrixApi.AccountBrandingPreview);
    });
