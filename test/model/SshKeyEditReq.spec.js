...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.SshKeyEditReq();
  });
  ...
  describe('SshKeyEditReq', function() {
    it('should create an instance of SshKeyEditReq', function() {
      // uncomment below and update the code to test SshKeyEditReq
      //var instane = new QuatrixApi.SshKeyEditReq();
      //expect(instance).to.be.a(QuatrixApi.SshKeyEditReq);
    });
