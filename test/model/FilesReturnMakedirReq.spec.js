...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.FilesReturnMakedirReq();
  });
  ...
  describe('FilesReturnMakedirReq', function() {
    it('should create an instance of FilesReturnMakedirReq', function() {
      // uncomment below and update the code to test FilesReturnMakedirReq
      //var instane = new QuatrixApi.FilesReturnMakedirReq();
      //expect(instance).to.be.a(QuatrixApi.FilesReturnMakedirReq);
    });
