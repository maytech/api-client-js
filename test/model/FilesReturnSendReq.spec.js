...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.FilesReturnSendReq();
  });
  ...
  describe('FilesReturnSendReq', function() {
    it('should create an instance of FilesReturnSendReq', function() {
      // uncomment below and update the code to test FilesReturnSendReq
      //var instane = new QuatrixApi.FilesReturnSendReq();
      //expect(instance).to.be.a(QuatrixApi.FilesReturnSendReq);
    });
