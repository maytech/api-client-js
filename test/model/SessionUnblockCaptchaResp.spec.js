...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.SessionUnblockCaptchaResp();
  });
  ...
  describe('SessionUnblockCaptchaResp', function() {
    it('should create an instance of SessionUnblockCaptchaResp', function() {
      // uncomment below and update the code to test SessionUnblockCaptchaResp
      //var instane = new QuatrixApi.SessionUnblockCaptchaResp();
      //expect(instance).to.be.a(QuatrixApi.SessionUnblockCaptchaResp);
    });
