...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ShortUserService();
  });
  ...
  describe('ShortUserService', function() {
    it('should create an instance of ShortUserService', function() {
      // uncomment below and update the code to test ShortUserService
      //var instane = new QuatrixApi.ShortUserService();
      //expect(instance).to.be.a(QuatrixApi.ShortUserService);
    });
    ...
    it('should have the property serviceKey (base name: "service_key")', function() {
