...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ProfileInfoResp();
  });
  ...
  describe('ProfileInfoResp', function() {
    it('should create an instance of ProfileInfoResp', function() {
      // uncomment below and update the code to test ProfileInfoResp
      //var instane = new QuatrixApi.ProfileInfoResp();
      //expect(instance).to.be.a(QuatrixApi.ProfileInfoResp);
    });

    it('should have the property userUsed (base name: "user_used")', function() {
      // uncomment below and update the code to test the property userUsed
      //var instane = new QuatrixApi.ProfileInfoResp();
      //expect(instance).to.be();
    });

    it('should have the property userLimit (base name: "user_limit")', function() {
      // uncomment below and update the code to test the property userLimit
      //var instane = new QuatrixApi.ProfileInfoResp();
      //expect(instance).to.be();
    });

    it('should have the property accUsed (base name: "acc_used")', function() {
      // uncomment below and update the code to test the property accUsed
      //var instane = new QuatrixApi.ProfileInfoResp();
      //expect(instance).to.be();
    });

    it('should have the property accLimit (base name: "acc_limit")', function() {
      // uncomment below and update the code to test the property accLimit
      //var instane = new QuatrixApi.ProfileInfoResp();
      //expect(instance).to.be();
    });
