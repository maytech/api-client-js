...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.SessionLoginPostResp();
  });
  ...
  describe('SessionLoginPostResp', function() {
    it('should create an instance of SessionLoginPostResp', function() {
      // uncomment below and update the code to test SessionLoginPostResp
      //var instane = new QuatrixApi.SessionLoginPostResp();
      //expect(instance).to.be.a(QuatrixApi.SessionLoginPostResp);
    });
