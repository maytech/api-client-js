...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.IdsResp();
  });
  ...
  describe('IdsResp', function() {
    it('should create an instance of IdsResp', function() {
      // uncomment below and update the code to test IdsResp
      //var instane = new QuatrixApi.IdsResp();
      //expect(instance).to.be.a(QuatrixApi.IdsResp);
    });
