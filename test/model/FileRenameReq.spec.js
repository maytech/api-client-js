...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.FileRenameReq();
  });
  ...
  describe('FileRenameReq', function() {
    it('should create an instance of FileRenameReq', function() {
      // uncomment below and update the code to test FileRenameReq
      //var instane = new QuatrixApi.FileRenameReq();
      //expect(instance).to.be.a(QuatrixApi.FileRenameReq);
    });
