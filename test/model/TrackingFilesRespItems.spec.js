...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.TrackingFilesRespItems();
  });
  ...
  describe('TrackingFilesRespItems', function() {
    it('should create an instance of TrackingFilesRespItems', function() {
      // uncomment below and update the code to test TrackingFilesRespItems
      //var instane = new QuatrixApi.TrackingFilesRespItems();
      //expect(instance).to.be.a(QuatrixApi.TrackingFilesRespItems);
    });
