...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.SettingsUploadLogoLinkResp();
  });
  ...
  describe('SettingsUploadLogoLinkResp', function() {
    it('should create an instance of SettingsUploadLogoLinkResp', function() {
      // uncomment below and update the code to test SettingsUploadLogoLinkResp
      //var instane = new QuatrixApi.SettingsUploadLogoLinkResp();
      //expect(instance).to.be.a(QuatrixApi.SettingsUploadLogoLinkResp);
    });

    it('should have the property uploadKey (base name: "upload_key")', function() {
