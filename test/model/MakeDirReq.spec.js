...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.MakeDirReq();
  });
  ...
  describe('MakeDirReq', function() {
    it('should create an instance of MakeDirReq', function() {
      // uncomment below and update the code to test MakeDirReq
      //var instane = new QuatrixApi.MakeDirReq();
      //expect(instance).to.be.a(QuatrixApi.MakeDirReq);
    });
