...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.UserSetMfaReq();
  });
  ...
  describe('UserSetMfaReq', function() {
    it('should create an instance of UserSetMfaReq', function() {
      // uncomment below and update the code to test UserSetMfaReq
      //var instane = new QuatrixApi.UserSetMfaReq();
      //expect(instance).to.be.a(QuatrixApi.UserSetMfaReq);
    });
