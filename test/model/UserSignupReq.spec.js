...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.UserSignupReq();
  });
  ...
  describe('UserSignupReq', function() {
    it('should create an instance of UserSignupReq', function() {
      // uncomment below and update the code to test UserSignupReq
      //var instane = new QuatrixApi.UserSignupReq();
      //expect(instance).to.be.a(QuatrixApi.UserSignupReq);
    });
