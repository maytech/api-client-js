...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ShareLoginPinReq();
  });
  ...
  describe('ShareLoginPinReq', function() {
    it('should create an instance of ShareLoginPinReq', function() {
      // uncomment below and update the code to test ShareLoginPinReq
      //var instane = new QuatrixApi.ShareLoginPinReq();
      //expect(instance).to.be.a(QuatrixApi.ShareLoginPinReq);
    });
