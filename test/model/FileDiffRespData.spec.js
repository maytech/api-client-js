...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.FileDiffRespData();
  });
  ...
  describe('FileDiffRespData', function() {
    it('should create an instance of FileDiffRespData', function() {
      // uncomment below and update the code to test FileDiffRespData
      //var instane = new QuatrixApi.FileDiffRespData();
      //expect(instance).to.be.a(QuatrixApi.FileDiffRespData);
    });
