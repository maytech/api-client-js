...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ServiceRespUsers();
  });
  ...
  describe('ServiceRespUsers', function() {
    it('should create an instance of ServiceRespUsers', function() {
      // uncomment below and update the code to test ServiceRespUsers
      //var instane = new QuatrixApi.ServiceRespUsers();
      //expect(instance).to.be.a(QuatrixApi.ServiceRespUsers);
    });
