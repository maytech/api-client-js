...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.CheckPingResp();
  });
  ...
  describe('CheckPingResp', function() {
    it('should create an instance of CheckPingResp', function() {
      // uncomment below and update the code to test CheckPingResp
      //var instane = new QuatrixApi.CheckPingResp();
      //expect(instance).to.be.a(QuatrixApi.CheckPingResp);
    });
