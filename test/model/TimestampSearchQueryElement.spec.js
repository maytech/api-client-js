...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.TimestampSearchQueryElement();
  });
  ...
  describe('TimestampSearchQueryElement', function() {
    it('should create an instance of TimestampSearchQueryElement', function() {
      // uncomment below and update the code to test TimestampSearchQueryElement
      //var instane = new QuatrixApi.TimestampSearchQueryElement();
      //expect(instance).to.be.a(QuatrixApi.TimestampSearchQueryElement);
    });

    it('should have the property and (base name: "_and")', function() {
      // uncomment below and update the code to test the property and
      //var instane = new QuatrixApi.TimestampSearchQueryElement();
      //expect(instance).to.be();
    });

    it('should have the property or (base name: "_or")', function() {
