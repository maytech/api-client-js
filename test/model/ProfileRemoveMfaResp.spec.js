...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ProfileRemoveMfaResp();
  });
  ...
  describe('ProfileRemoveMfaResp', function() {
    it('should create an instance of ProfileRemoveMfaResp', function() {
      // uncomment below and update the code to test ProfileRemoveMfaResp
      //var instane = new QuatrixApi.ProfileRemoveMfaResp();
      //expect(instance).to.be.a(QuatrixApi.ProfileRemoveMfaResp);
    });
