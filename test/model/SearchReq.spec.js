...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.SearchReq();
  });
  ...
  describe('SearchReq', function() {
    it('should create an instance of SearchReq', function() {
      // uncomment below and update the code to test SearchReq
      //var instane = new QuatrixApi.SearchReq();
      //expect(instance).to.be.a(QuatrixApi.SearchReq);
    });
