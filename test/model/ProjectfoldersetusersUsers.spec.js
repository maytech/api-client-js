...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ProjectfoldersetusersUsers();
  });
  ...
  describe('ProjectfoldersetusersUsers', function() {
    it('should create an instance of ProjectfoldersetusersUsers', function() {
      // uncomment below and update the code to test ProjectfoldersetusersUsers
      //var instane = new QuatrixApi.ProjectfoldersetusersUsers();
      //expect(instance).to.be.a(QuatrixApi.ProjectfoldersetusersUsers);
    });
