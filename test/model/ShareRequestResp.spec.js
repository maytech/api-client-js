...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ShareRequestResp();
  });
  ...
  describe('ShareRequestResp', function() {
    it('should create an instance of ShareRequestResp', function() {
      // uncomment below and update the code to test ShareRequestResp
      //var instane = new QuatrixApi.ShareRequestResp();
      //expect(instance).to.be.a(QuatrixApi.ShareRequestResp);
    });
