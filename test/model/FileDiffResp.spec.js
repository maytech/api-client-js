...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.FileDiffResp();
  });
  ...
  describe('FileDiffResp', function() {
    it('should create an instance of FileDiffResp', function() {
      // uncomment below and update the code to test FileDiffResp
      //var instane = new QuatrixApi.FileDiffResp();
      //expect(instance).to.be.a(QuatrixApi.FileDiffResp);
    });
