...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ProfileSetReq();
  });
  ...
  describe('ProfileSetReq', function() {
    it('should create an instance of ProfileSetReq', function() {
      // uncomment below and update the code to test ProfileSetReq
      //var instane = new QuatrixApi.ProfileSetReq();
      //expect(instance).to.be.a(QuatrixApi.ProfileSetReq);
    });
