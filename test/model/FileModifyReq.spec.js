...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.FileModifyReq();
  });
  ...
  describe('FileModifyReq', function() {
    it('should create an instance of FileModifyReq', function() {
      // uncomment below and update the code to test FileModifyReq
      //var instane = new QuatrixApi.FileModifyReq();
      //expect(instance).to.be.a(QuatrixApi.FileModifyReq);
    });
    ...
    it('should have the property truncate (base name: "truncate")', function() {
      // uncomment below and update the code to test the property truncate
      //var instane = new QuatrixApi.FileModifyReq();
      //expect(instance).to.be();
    });
