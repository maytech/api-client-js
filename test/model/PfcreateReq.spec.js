...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.PfcreateReq();
  });
  ...
  describe('PfcreateReq', function() {
    it('should create an instance of PfcreateReq', function() {
      // uncomment below and update the code to test PfcreateReq
      //var instane = new QuatrixApi.PfcreateReq();
      //expect(instance).to.be.a(QuatrixApi.PfcreateReq);
    });
