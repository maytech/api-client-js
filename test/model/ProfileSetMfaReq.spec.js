...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ProfileSetMfaReq();
  });
  ...
  describe('ProfileSetMfaReq', function() {
    it('should create an instance of ProfileSetMfaReq', function() {
      // uncomment below and update the code to test ProfileSetMfaReq
      //var instane = new QuatrixApi.ProfileSetMfaReq();
      //expect(instance).to.be.a(QuatrixApi.ProfileSetMfaReq);
    });
