...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ShareRequestReq();
  });
  ...
  describe('ShareRequestReq', function() {
    it('should create an instance of ShareRequestReq', function() {
      // uncomment below and update the code to test ShareRequestReq
      //var instane = new QuatrixApi.ShareRequestReq();
      //expect(instance).to.be.a(QuatrixApi.ShareRequestReq);
    });
