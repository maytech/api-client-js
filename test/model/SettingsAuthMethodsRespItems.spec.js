...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.SettingsAuthMethodsRespItems();
  });
  ...
  describe('SettingsAuthMethodsRespItems', function() {
    it('should create an instance of SettingsAuthMethodsRespItems', function() {
      // uncomment below and update the code to test SettingsAuthMethodsRespItems
      //var instane = new QuatrixApi.SettingsAuthMethodsRespItems();
      //expect(instance).to.be.a(QuatrixApi.SettingsAuthMethodsRespItems);
    });
