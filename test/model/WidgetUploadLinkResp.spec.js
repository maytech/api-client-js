...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.WidgetUploadLinkResp();
  });
  ...
  describe('WidgetUploadLinkResp', function() {
    it('should create an instance of WidgetUploadLinkResp', function() {
      // uncomment below and update the code to test WidgetUploadLinkResp
      //var instane = new QuatrixApi.WidgetUploadLinkResp();
      //expect(instance).to.be.a(QuatrixApi.WidgetUploadLinkResp);
    });
