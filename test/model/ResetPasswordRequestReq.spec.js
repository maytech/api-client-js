...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ResetPasswordRequestReq();
  });
  ...
  describe('ResetPasswordRequestReq', function() {
    it('should create an instance of ResetPasswordRequestReq', function() {
      // uncomment below and update the code to test ResetPasswordRequestReq
      //var instane = new QuatrixApi.ResetPasswordRequestReq();
      //expect(instance).to.be.a(QuatrixApi.ResetPasswordRequestReq);
    });
