...
(function(root, factory) {
  ...
  describe('FileInfoResp', function() {
    ...
    it('should have the property antivirusCheck (base name: "antivirus_check")', function() {
      expect(instance).to.have.property("antivirus_check");
    });

    it('should have the property widgetMetadata (base name: "widget_metadata")', function() {
      expect(instance).to.have.property("widget_metadata");
    });
