...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.FileMetadataGetResp();
  });
  ...
  describe('FileMetadataGetResp', function() {
    it('should create an instance of FileMetadataGetResp', function() {
      // uncomment below and update the code to test FileMetadataGetResp
      //var instane = new QuatrixApi.FileMetadataGetResp();
      //expect(instance).to.be.a(QuatrixApi.FileMetadataGetResp);
    });
