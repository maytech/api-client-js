...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ProjectfolderdeleteusersUsers();
  });
  ...
  describe('ProjectfolderdeleteusersUsers', function() {
    it('should create an instance of ProjectfolderdeleteusersUsers', function() {
      // uncomment below and update the code to test ProjectfolderdeleteusersUsers
      //var instane = new QuatrixApi.ProjectfolderdeleteusersUsers();
      //expect(instance).to.be.a(QuatrixApi.ProjectfolderdeleteusersUsers);
    });
