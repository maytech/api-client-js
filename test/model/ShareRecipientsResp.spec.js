...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ShareRecipientsResp();
  });
  ...
  describe('ShareRecipientsResp', function() {
    it('should create an instance of ShareRecipientsResp', function() {
      // uncomment below and update the code to test ShareRecipientsResp
      //var instane = new QuatrixApi.ShareRecipientsResp();
      //expect(instance).to.be.a(QuatrixApi.ShareRecipientsResp);
    });
