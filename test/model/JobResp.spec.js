...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.JobResp();
  });
  ...
  describe('JobResp', function() {
    it('should create an instance of JobResp', function() {
      // uncomment below and update the code to test JobResp
      //var instane = new QuatrixApi.JobResp();
      //expect(instance).to.be.a(QuatrixApi.JobResp);
    });
