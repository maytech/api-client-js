...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.FileAddTagReq();
  });
  ...
  describe('FileAddTagReq', function() {
    it('should create an instance of FileAddTagReq', function() {
      // uncomment below and update the code to test FileAddTagReq
      //var instane = new QuatrixApi.FileAddTagReq();
      //expect(instance).to.be.a(QuatrixApi.FileAddTagReq);
    });
