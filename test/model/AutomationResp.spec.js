...
(function(root, factory) {
  ...
  describe('AutomationResp', function() {
    it('should create an instance of AutomationResp', function() {
      // uncomment below and update the code to test AutomationResp
      //var instane = new QuatrixApi.AutomationResp();
    ...
    it('should have the property ruleNum (base name: "rule_num")', function() {
      // uncomment below and update the code to test the property ruleNum
      //var instane = new QuatrixApi.AutomationResp();
      //expect(instance).to.be();
    });
