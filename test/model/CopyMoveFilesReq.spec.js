...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.CopyMoveFilesReq();
  });
  ...
  describe('CopyMoveFilesReq', function() {
    it('should create an instance of CopyMoveFilesReq', function() {
      // uncomment below and update the code to test CopyMoveFilesReq
      //var instane = new QuatrixApi.CopyMoveFilesReq();
      //expect(instance).to.be.a(QuatrixApi.CopyMoveFilesReq);
    });
    ...
    it('should have the property resolve (base name: "resolve")', function() {
      // uncomment below and update the code to test the property resolve
      //var instane = new QuatrixApi.CopyMoveFilesReq();
      //expect(instance).to.be();
    });
