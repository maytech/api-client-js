...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.FilesReturnUploadLinkResp();
  });
  ...
  describe('FilesReturnUploadLinkResp', function() {
    it('should create an instance of FilesReturnUploadLinkResp', function() {
      // uncomment below and update the code to test FilesReturnUploadLinkResp
      //var instane = new QuatrixApi.FilesReturnUploadLinkResp();
      //expect(instance).to.be.a(QuatrixApi.FilesReturnUploadLinkResp);
    });
