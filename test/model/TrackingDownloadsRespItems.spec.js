...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.TrackingDownloadsRespItems();
  });
  ...
  describe('TrackingDownloadsRespItems', function() {
    it('should create an instance of TrackingDownloadsRespItems', function() {
      // uncomment below and update the code to test TrackingDownloadsRespItems
      //var instane = new QuatrixApi.TrackingDownloadsRespItems();
      //expect(instance).to.be.a(QuatrixApi.TrackingDownloadsRespItems);
    });
