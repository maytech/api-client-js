...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.PgpKeyRecipientsRespItems();
  });
  ...
  describe('PgpKeyRecipientsRespItems', function() {
    it('should create an instance of PgpKeyRecipientsRespItems', function() {
      // uncomment below and update the code to test PgpKeyRecipientsRespItems
      //var instane = new QuatrixApi.PgpKeyRecipientsRespItems();
      //expect(instance).to.be.a(QuatrixApi.PgpKeyRecipientsRespItems);
    });
