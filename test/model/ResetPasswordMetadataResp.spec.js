...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ResetPasswordMetadataResp();
  });
  ...
  describe('ResetPasswordMetadataResp', function() {
    it('should create an instance of ResetPasswordMetadataResp', function() {
      // uncomment below and update the code to test ResetPasswordMetadataResp
      //var instane = new QuatrixApi.ResetPasswordMetadataResp();
      //expect(instance).to.be.a(QuatrixApi.ResetPasswordMetadataResp);
    });
    ...
    it('should have the property multipleAccounts (base name: "multiple_accounts")', function() {
      // uncomment below and update the code to test the property multipleAccounts
      //var instane = new QuatrixApi.ResetPasswordMetadataResp();
      //expect(instance).to.be();
    });
