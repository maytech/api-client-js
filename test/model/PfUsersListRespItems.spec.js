...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.PfUsersListRespItems();
  });
  ...
  describe('PfUsersListRespItems', function() {
    it('should create an instance of PfUsersListRespItems', function() {
      // uncomment below and update the code to test PfUsersListRespItems
      //var instane = new QuatrixApi.PfUsersListRespItems();
      //expect(instance).to.be.a(QuatrixApi.PfUsersListRespItems);
    });
