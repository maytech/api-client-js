...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.FilePreviewResp();
  });
  ...
  describe('FilePreviewResp', function() {
    it('should create an instance of FilePreviewResp', function() {
      // uncomment below and update the code to test FilePreviewResp
      //var instane = new QuatrixApi.FilePreviewResp();
      //expect(instance).to.be.a(QuatrixApi.FilePreviewResp);
    });
    ...
    it('should have the property sourcePdf (base name: "source_pdf")', function() {
      // uncomment below and update the code to test the property sourcePdf
      //var instane = new QuatrixApi.FilePreviewResp();
      //expect(instance).to.be();
    });
