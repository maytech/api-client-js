...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ProjectfoldersetusersParams();
  });
  ...
  describe('ProjectfoldersetusersParams', function() {
    it('should create an instance of ProjectfoldersetusersParams', function() {
      // uncomment below and update the code to test ProjectfoldersetusersParams
      //var instane = new QuatrixApi.ProjectfoldersetusersParams();
      //expect(instance).to.be.a(QuatrixApi.ProjectfoldersetusersParams);
    });
