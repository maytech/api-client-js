...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.AutomationDeleteResp();
  });
  ...
  describe('AutomationDeleteResp', function() {
    it('should create an instance of AutomationDeleteResp', function() {
      // uncomment below and update the code to test AutomationDeleteResp
      //var instane = new QuatrixApi.AutomationDeleteResp();
      //expect(instance).to.be.a(QuatrixApi.AutomationDeleteResp);
    });
