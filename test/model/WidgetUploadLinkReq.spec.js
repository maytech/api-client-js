...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.WidgetUploadLinkReq();
  });
  ...
  describe('WidgetUploadLinkReq', function() {
    it('should create an instance of WidgetUploadLinkReq', function() {
      // uncomment below and update the code to test WidgetUploadLinkReq
      //var instane = new QuatrixApi.WidgetUploadLinkReq();
      //expect(instance).to.be.a(QuatrixApi.WidgetUploadLinkReq);
    });
