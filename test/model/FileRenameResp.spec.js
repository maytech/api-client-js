...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.FileRenameResp();
  });
  ...
  describe('FileRenameResp', function() {
    it('should create an instance of FileRenameResp', function() {
      // uncomment below and update the code to test FileRenameResp
      //var instane = new QuatrixApi.FileRenameResp();
      //expect(instance).to.be.a(QuatrixApi.FileRenameResp);
    });
