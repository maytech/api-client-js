...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.AccountRolesRespItems();
  });
  ...
  describe('AccountRolesRespItems', function() {
    it('should create an instance of AccountRolesRespItems', function() {
      // uncomment below and update the code to test AccountRolesRespItems
      //var instane = new QuatrixApi.AccountRolesRespItems();
      //expect(instance).to.be.a(QuatrixApi.AccountRolesRespItems);
    });
