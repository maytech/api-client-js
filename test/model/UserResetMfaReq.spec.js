...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.UserResetMfaReq();
  });
  ...
  describe('UserResetMfaReq', function() {
    it('should create an instance of UserResetMfaReq', function() {
      expect(instance).to.be.a(QuatrixApi.UserResetMfaReq);
    });
