...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.FileTagResp();
  });
  ...
  describe('FileTagResp', function() {
    it('should create an instance of FileTagResp', function() {
      // uncomment below and update the code to test FileTagResp
      //var instane = new QuatrixApi.FileTagResp();
      //expect(instance).to.be.a(QuatrixApi.FileTagResp);
    });
