...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.QuicklinkCreateReq();
  });
  ...
  describe('QuicklinkCreateReq', function() {
    it('should create an instance of QuicklinkCreateReq', function() {
      // uncomment below and update the code to test QuicklinkCreateReq
      //var instane = new QuatrixApi.QuicklinkCreateReq();
      //expect(instance).to.be.a(QuatrixApi.QuicklinkCreateReq);
    });
