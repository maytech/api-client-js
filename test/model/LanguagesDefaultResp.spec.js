...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.LanguagesDefaultResp();
  });
  ...
  describe('LanguagesDefaultResp', function() {
    it('should create an instance of LanguagesDefaultResp', function() {
      // uncomment below and update the code to test LanguagesDefaultResp
      //var instane = new QuatrixApi.LanguagesDefaultResp();
      //expect(instance).to.be.a(QuatrixApi.LanguagesDefaultResp);
    });
