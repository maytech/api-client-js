...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.UserDeleteReq();
  });
  ...
  describe('UserDeleteReq', function() {
    it('should create an instance of UserDeleteReq', function() {
      // uncomment below and update the code to test UserDeleteReq
      //var instane = new QuatrixApi.UserDeleteReq();
      //expect(instance).to.be.a(QuatrixApi.UserDeleteReq);
    });
    ...
    it('should have the property deleteHome (base name: "delete_home")', function() {
      // uncomment below and update the code to test the property deleteHome
      //var instane = new QuatrixApi.UserDeleteReq();
      //expect(instance).to.be();
    });
