...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ShareFilesRespItems();
  });
  ...
  describe('ShareFilesRespItems', function() {
    it('should create an instance of ShareFilesRespItems', function() {
      // uncomment below and update the code to test ShareFilesRespItems
      //var instane = new QuatrixApi.ShareFilesRespItems();
      //expect(instance).to.be.a(QuatrixApi.ShareFilesRespItems);
    });
    ...
    it('should have the property downloadLocked (base name: "download_locked")', function() {
      // uncomment below and update the code to test the property downloadLocked
      //var instane = new QuatrixApi.ShareFilesRespItems();
      //expect(instance).to.be();
    });
