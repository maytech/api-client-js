...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.FilesReturnMakedirResps();
  });
  ...
  describe('FilesReturnMakedirResps', function() {
    it('should create an instance of FilesReturnMakedirResps', function() {
      // uncomment below and update the code to test FilesReturnMakedirResps
      //var instane = new QuatrixApi.FilesReturnMakedirResps();
      //expect(instance).to.be.a(QuatrixApi.FilesReturnMakedirResps);
    });
