...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ContactDeleteRespItems();
  });
  ...
  describe('ContactDeleteRespItems', function() {
    it('should create an instance of ContactDeleteRespItems', function() {
      // uncomment below and update the code to test ContactDeleteRespItems
      //var instane = new QuatrixApi.ContactDeleteRespItems();
      //expect(instance).to.be.a(QuatrixApi.ContactDeleteRespItems);
    });
