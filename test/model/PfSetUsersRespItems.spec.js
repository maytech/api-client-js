...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.PfSetUsersRespItems();
  });
  ...
  describe('PfSetUsersRespItems', function() {
    it('should create an instance of PfSetUsersRespItems', function() {
      // uncomment below and update the code to test PfSetUsersRespItems
      //var instane = new QuatrixApi.PfSetUsersRespItems();
      //expect(instance).to.be.a(QuatrixApi.PfSetUsersRespItems);
    });
