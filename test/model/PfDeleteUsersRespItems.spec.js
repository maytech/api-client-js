...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.PfDeleteUsersRespItems();
  });
  ...
  describe('PfDeleteUsersRespItems', function() {
    it('should create an instance of PfDeleteUsersRespItems', function() {
      // uncomment below and update the code to test PfDeleteUsersRespItems
      //var instane = new QuatrixApi.PfDeleteUsersRespItems();
      //expect(instance).to.be.a(QuatrixApi.PfDeleteUsersRespItems);
    });
