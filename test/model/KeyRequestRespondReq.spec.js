...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.KeyRequestRespondReq();
  });
  ...
  describe('KeyRequestRespondReq', function() {
    it('should create an instance of KeyRequestRespondReq', function() {
      // uncomment below and update the code to test KeyRequestRespondReq
      //var instane = new QuatrixApi.KeyRequestRespondReq();
      //expect(instance).to.be.a(QuatrixApi.KeyRequestRespondReq);
    });
