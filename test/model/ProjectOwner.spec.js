...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ProjectOwner();
  });
  ...
  describe('ProjectOwner', function() {
    it('should create an instance of ProjectOwner', function() {
      // uncomment below and update the code to test ProjectOwner
      //var instane = new QuatrixApi.ProjectOwner();
      //expect(instance).to.be.a(QuatrixApi.ProjectOwner);
    });
