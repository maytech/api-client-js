...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.SessionLoginResp();
  });
  ...
  describe('SessionLoginResp', function() {
    it('should create an instance of SessionLoginResp', function() {
      // uncomment below and update the code to test SessionLoginResp
      //var instane = new QuatrixApi.SessionLoginResp();
      //expect(instance).to.be.a(QuatrixApi.SessionLoginResp);
    });
