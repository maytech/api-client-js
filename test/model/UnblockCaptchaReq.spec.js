...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.UnblockCaptchaReq();
  });
  ...
  describe('UnblockCaptchaReq', function() {
    it('should create an instance of UnblockCaptchaReq', function() {
      // uncomment below and update the code to test UnblockCaptchaReq
      //var instane = new QuatrixApi.UnblockCaptchaReq();
      //expect(instance).to.be.a(QuatrixApi.UnblockCaptchaReq);
    });
