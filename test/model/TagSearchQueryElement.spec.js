...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.TagSearchQueryElement();
  });
  ...
  describe('TagSearchQueryElement', function() {
    it('should create an instance of TagSearchQueryElement', function() {
      // uncomment below and update the code to test TagSearchQueryElement
      //var instane = new QuatrixApi.TagSearchQueryElement();
      //expect(instance).to.be.a(QuatrixApi.TagSearchQueryElement);
    });
