...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.PfaddUsersReq();
  });
  ...
  describe('PfaddUsersReq', function() {
    it('should create an instance of PfaddUsersReq', function() {
      // uncomment below and update the code to test PfaddUsersReq
      //var instane = new QuatrixApi.PfaddUsersReq();
      //expect(instance).to.be.a(QuatrixApi.PfaddUsersReq);
    });
