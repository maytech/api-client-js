...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ProjectFoldersListRespItem();
  });
  ...
  describe('ProjectFoldersListRespItem', function() {
    it('should create an instance of ProjectFoldersListRespItem', function() {
      // uncomment below and update the code to test ProjectFoldersListRespItem
      //var instane = new QuatrixApi.ProjectFoldersListRespItem();
      //expect(instance).to.be.a(QuatrixApi.ProjectFoldersListRespItem);
    });
