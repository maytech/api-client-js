...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.PfdeleteUsersReq();
  });
  ...
  describe('PfdeleteUsersReq', function() {
    it('should create an instance of PfdeleteUsersReq', function() {
      // uncomment below and update the code to test PfdeleteUsersReq
      //var instane = new QuatrixApi.PfdeleteUsersReq();
      //expect(instance).to.be.a(QuatrixApi.PfdeleteUsersReq);
    });
