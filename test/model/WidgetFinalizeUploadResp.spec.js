...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.WidgetFinalizeUploadResp();
  });
  ...
  describe('WidgetFinalizeUploadResp', function() {
    it('should create an instance of WidgetFinalizeUploadResp', function() {
      // uncomment below and update the code to test WidgetFinalizeUploadResp
      //var instane = new QuatrixApi.WidgetFinalizeUploadResp();
      //expect(instance).to.be.a(QuatrixApi.WidgetFinalizeUploadResp);
    });
