...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ProfileSetPasswordResp();
  });
  ...
  describe('ProfileSetPasswordResp', function() {
    it('should create an instance of ProfileSetPasswordResp', function() {
      // uncomment below and update the code to test ProfileSetPasswordResp
      //var instane = new QuatrixApi.ProfileSetPasswordResp();
      //expect(instance).to.be.a(QuatrixApi.ProfileSetPasswordResp);
    });
