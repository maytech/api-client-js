...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.UploadFinalizeResp();
  });
  ...
  describe('UploadFinalizeResp', function() {
    it('should create an instance of UploadFinalizeResp', function() {
      // uncomment below and update the code to test UploadFinalizeResp
      //var instane = new QuatrixApi.UploadFinalizeResp();
      //expect(instance).to.be.a(QuatrixApi.UploadFinalizeResp);
    });
