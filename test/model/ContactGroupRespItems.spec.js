...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ContactGroupRespItems();
  });
  ...
  describe('ContactGroupRespItems', function() {
    it('should create an instance of ContactGroupRespItems', function() {
      // uncomment below and update the code to test ContactGroupRespItems
      //var instane = new QuatrixApi.ContactGroupRespItems();
      //expect(instance).to.be.a(QuatrixApi.ContactGroupRespItems);
    });
