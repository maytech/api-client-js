...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.LanguagesRespItems();
  });
  ...
  describe('LanguagesRespItems', function() {
    it('should create an instance of LanguagesRespItems', function() {
      // uncomment below and update the code to test LanguagesRespItems
      //var instane = new QuatrixApi.LanguagesRespItems();
      //expect(instance).to.be.a(QuatrixApi.LanguagesRespItems);
    });
