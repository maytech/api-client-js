...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ResetPasswordRequestResp();
  });
  ...
  describe('ResetPasswordRequestResp', function() {
    it('should create an instance of ResetPasswordRequestResp', function() {
      // uncomment below and update the code to test ResetPasswordRequestResp
      //var instane = new QuatrixApi.ResetPasswordRequestResp();
      //expect(instance).to.be.a(QuatrixApi.ResetPasswordRequestResp);
    });
