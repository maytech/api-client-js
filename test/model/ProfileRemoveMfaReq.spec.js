...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ProfileRemoveMfaReq();
  });
  ...
  describe('ProfileRemoveMfaReq', function() {
    it('should create an instance of ProfileRemoveMfaReq', function() {
      // uncomment below and update the code to test ProfileRemoveMfaReq
      //var instane = new QuatrixApi.ProfileRemoveMfaReq();
      //expect(instance).to.be.a(QuatrixApi.ProfileRemoveMfaReq);
    });
