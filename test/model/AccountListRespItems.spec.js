...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.AccountListRespItems();
  });
  ...
  describe('AccountListRespItems', function() {
    it('should create an instance of AccountListRespItems', function() {
      // uncomment below and update the code to test AccountListRespItems
      //var instane = new QuatrixApi.AccountListRespItems();
      //expect(instance).to.be.a(QuatrixApi.AccountListRespItems);
    });
