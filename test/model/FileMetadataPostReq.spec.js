...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.FileMetadataPostReq();
  });
  ...
  describe('FileMetadataPostReq', function() {
    it('should create an instance of FileMetadataPostReq', function() {
      // uncomment below and update the code to test FileMetadataPostReq
      //var instane = new QuatrixApi.FileMetadataPostReq();
      //expect(instance).to.be.a(QuatrixApi.FileMetadataPostReq);
    });
