...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ProfileSetPasswordReq();
  });
  ...
  describe('ProfileSetPasswordReq', function() {
    it('should create an instance of ProfileSetPasswordReq', function() {
      // uncomment below and update the code to test ProfileSetPasswordReq
      //var instane = new QuatrixApi.ProfileSetPasswordReq();
      //expect(instance).to.be.a(QuatrixApi.ProfileSetPasswordReq);
    });
