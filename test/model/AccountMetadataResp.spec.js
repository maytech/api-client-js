...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.AccountMetadataResp();
  });
  ...
  describe('AccountMetadataResp', function() {
    it('should create an instance of AccountMetadataResp', function() {
      // uncomment below and update the code to test AccountMetadataResp
      //var instane = new QuatrixApi.AccountMetadataResp();
      //expect(instance).to.be.a(QuatrixApi.AccountMetadataResp);
    });
    ...
    it('should have the property defaultLogo (base name: "default_logo")', function() {
