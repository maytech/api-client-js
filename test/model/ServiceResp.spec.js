...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ServiceResp();
  });
  ...
  describe('ServiceResp', function() {
    it('should create an instance of ServiceResp', function() {
      // uncomment below and update the code to test ServiceResp
      //var instane = new QuatrixApi.ServiceResp();
      //expect(instance).to.be.a(QuatrixApi.ServiceResp);
    });
