...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuatrixApi.ShareSendRequestReq();
  });
  ...
  describe('ShareSendRequestReq', function() {
    it('should create an instance of ShareSendRequestReq', function() {
      // uncomment below and update the code to test ShareSendRequestReq
      //var instane = new QuatrixApi.ShareSendRequestReq();
      //expect(instance).to.be.a(QuatrixApi.ShareSendRequestReq);
    });
