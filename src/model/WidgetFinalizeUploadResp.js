...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.QuatrixApi.WidgetFinalizeUploadResp = factory(root.QuatrixApi.ApiClient);
  }
  ...
  /**
   * The WidgetFinalizeUploadResp model module.
   * @module model/WidgetFinalizeUploadResp
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>WidgetFinalizeUploadResp</code>.
   * @alias module:model/WidgetFinalizeUploadResp
   * @class
   */
  ...
  /**
   * Constructs a <code>WidgetFinalizeUploadResp</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/WidgetFinalizeUploadResp} obj Optional instance to populate.
   * @return {module:model/WidgetFinalizeUploadResp} The populated <code>WidgetFinalizeUploadResp</code> instance.
   */
