...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.QuatrixApi.FileResp = factory(root.QuatrixApi.ApiClient);
  }
  ...
  /**
   * The FileResp model module.
   * @module model/FileResp
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>FileResp</code>.
   * @alias module:model/FileResp
   * @class
   */
  ...
  /**
   * Constructs a <code>FileResp</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FileResp} obj Optional instance to populate.
   * @return {module:model/FileResp} The populated <code>FileResp</code> instance.
   */
