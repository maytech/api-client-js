...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.QuatrixApi.PfUsersListReq = factory(root.QuatrixApi.ApiClient);
  }
  ...
  /**
   * The PfUsersListReq model module.
   * @module model/PfUsersListReq
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PfUsersListReq</code>.
   * @alias module:model/PfUsersListReq
   * @class
  ...
  /**
   * Constructs a <code>PfUsersListReq</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PfUsersListReq} obj Optional instance to populate.
   * @return {module:model/PfUsersListReq} The populated <code>PfUsersListReq</code> instance.
   */
