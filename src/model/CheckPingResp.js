...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.QuatrixApi.CheckPingResp = factory(root.QuatrixApi.ApiClient);
  }
  ...
  /**
   * The CheckPingResp model module.
   * @module model/CheckPingResp
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CheckPingResp</code>.
   * @alias module:model/CheckPingResp
   * @class
   */
  ...
  /**
   * Constructs a <code>CheckPingResp</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CheckPingResp} obj Optional instance to populate.
   * @return {module:model/CheckPingResp} The populated <code>CheckPingResp</code> instance.
   */
