...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.QuatrixApi.FileRenameReq = factory(root.QuatrixApi.ApiClient);
  }
  ...
  /**
   * The FileRenameReq model module.
   * @module model/FileRenameReq
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>FileRenameReq</code>.
   * @alias module:model/FileRenameReq
   * @class
   */
  ...
  /**
   * Constructs a <code>FileRenameReq</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FileRenameReq} obj Optional instance to populate.
   * @return {module:model/FileRenameReq} The populated <code>FileRenameReq</code> instance.
   */
