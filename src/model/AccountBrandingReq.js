...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.QuatrixApi.AccountBrandingReq = factory(root.QuatrixApi.ApiClient);
  }
  ...
  /**
   * The AccountBrandingReq model module.
   * @module model/AccountBrandingReq
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>AccountBrandingReq</code>.
   * @alias module:model/AccountBrandingReq
   * @class
   */
  ...
  /**
   * Constructs a <code>AccountBrandingReq</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AccountBrandingReq} obj Optional instance to populate.
   * @return {module:model/AccountBrandingReq} The populated <code>AccountBrandingReq</code> instance.
   */
