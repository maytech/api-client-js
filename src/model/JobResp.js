...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.QuatrixApi.JobResp = factory(root.QuatrixApi.ApiClient);
  }
  ...
  /**
   * The JobResp model module.
   * @module model/JobResp
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>JobResp</code>.
   * @alias module:model/JobResp
   * @class
   */
  ...
  /**
   * Constructs a <code>JobResp</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/JobResp} obj Optional instance to populate.
   * @return {module:model/JobResp} The populated <code>JobResp</code> instance.
   */
