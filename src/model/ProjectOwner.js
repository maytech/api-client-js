...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.QuatrixApi.ProjectOwner = factory(root.QuatrixApi.ApiClient);
  }
  ...
  /**
   * The ProjectOwner model module.
   * @module model/ProjectOwner
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ProjectOwner</code>.
   * @alias module:model/ProjectOwner
   * @class
   */
  ...
  /**
   * Constructs a <code>ProjectOwner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ProjectOwner} obj Optional instance to populate.
   * @return {module:model/ProjectOwner} The populated <code>ProjectOwner</code> instance.
   */
