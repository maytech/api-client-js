...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.QuatrixApi.AutomationDeleteResp = factory(root.QuatrixApi.ApiClient);
  }
  ...
  /**
   * The AutomationDeleteResp model module.
   * @module model/AutomationDeleteResp
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>AutomationDeleteResp</code>.
   * @alias module:model/AutomationDeleteResp
   * @class
   */
  ...
  /**
   * Constructs a <code>AutomationDeleteResp</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AutomationDeleteResp} obj Optional instance to populate.
   * @return {module:model/AutomationDeleteResp} The populated <code>AutomationDeleteResp</code> instance.
   */
