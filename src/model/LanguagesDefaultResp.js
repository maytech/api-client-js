...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.QuatrixApi.LanguagesDefaultResp = factory(root.QuatrixApi.ApiClient);
  }
  ...
  /**
   * The LanguagesDefaultResp model module.
   * @module model/LanguagesDefaultResp
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>LanguagesDefaultResp</code>.
   * @alias module:model/LanguagesDefaultResp
   * @class
   */
  ...
  /**
   * Constructs a <code>LanguagesDefaultResp</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LanguagesDefaultResp} obj Optional instance to populate.
   * @return {module:model/LanguagesDefaultResp} The populated <code>LanguagesDefaultResp</code> instance.
   */
