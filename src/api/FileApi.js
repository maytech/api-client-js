...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/FileApi~fileWopiTokenIdGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/IdResp} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Get wopi token for file 
     * @param {String} id ID of a file
     * @param {module:api/FileApi~fileWopiTokenIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IdResp}
     */
